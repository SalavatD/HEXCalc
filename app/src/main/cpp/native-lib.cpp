...
Java_com_anytrash_hexcalc_MainActivity_calculate(JNIEnv *env, jobject /* this */, jint operand1,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_anytrash_hexcalc_MainActivity_calculateNoDec(JNIEnv *env, jobject /* this */,
